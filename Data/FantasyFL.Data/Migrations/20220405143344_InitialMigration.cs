    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    StartGameweekId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Gameweeks_StartGameweekId",
                        column: x => x.StartGameweekId,
            ...
            migrationBuilder.CreateTable(
                name: "ApplicationUserFantasyLeague",
                columns: table => new
                {
                    ApplicationUsersId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    FantasyLeaguesId = table.Column<int>(type: "int", nullable: false),
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUserFantasyLeague", x => new { x.ApplicationUsersId, x.FantasyLeaguesId });
                    table.ForeignKey(
                        name: "FK_ApplicationUserFantasyLeague_AspNetUsers_ApplicationUsersId",
                        column: x => x.ApplicationUsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ApplicationUserFantasyLeague_FantasyLeagues_FantasyLeaguesId",
                        column: x => x.FantasyLeaguesId,
            ...
            migrationBuilder.CreateTable(
                name: "ApplicationUsersGameweeks",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUsersGameweeks", x => new { x.UserId, x.GameweekId });
                    table.ForeignKey(
                        name: "FK_ApplicationUsersGameweeks_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ApplicationUsersGameweeks_Gameweeks_GameweekId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FantasyTeams_AspNetUsers_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FantasyTeamsPlayers", x => new { x.FantasyTeamId, x.PlayerId });
                    table.ForeignKey(
                        name: "FK_FantasyTeamsPlayers_FantasyTeams_FantasyTeamId",
                        column: x => x.FantasyTeamId,
                        principalTable: "FantasyTeams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FantasyTeamsPlayers_Players_PlayerId",
                        column: x => x.PlayerId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserFantasyLeague_FantasyLeaguesId",
                table: "ApplicationUserFantasyLeague",
                column: "FantasyLeaguesId");

            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUsersGameweeks_GameweekId",
                table: "ApplicationUsersGameweeks",
                column: "GameweekId");

            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUsersGameweeks_IsDeleted",
                table: "ApplicationUsersGameweeks",
                column: "IsDeleted");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_StartGameweekId",
                table: "AspNetUsers",
                column: "StartGameweekId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FantasyLeagues_IsDeleted",
                table: "FantasyLeagues",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_FantasyTeams_IsDeleted",
                table: "FantasyTeams",
                column: "IsDeleted");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FantasyTeamsPlayers_IsDeleted",
                table: "FantasyTeamsPlayers",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_FantasyTeamsPlayers_PlayerId",
                table: "FantasyTeamsPlayers",
                column: "PlayerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlayersGameweeks_IsDeleted",
                table: "PlayersGameweeks",
                column: "IsDeleted");
